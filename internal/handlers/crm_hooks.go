...
//
// Mensajes WhatsApp NO se espejan por este canal — el CRM tiene un
// driver "centralita" propio que consume directamente /api/messages/send
// y expone /api/pbx/whatsapp-incoming, así que el mirror ya va por ahí.
